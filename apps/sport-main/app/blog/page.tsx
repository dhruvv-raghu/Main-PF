          ...
          <div className="w-full">
            <header className="text-center pt-24 pb-16">
              <div className="flex flex-col items-center w-full mx-auto relative">
                <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-32 h-32 bg-[#0d1b2a]/5 rounded-full blur-3xl"></div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="w-24 h-1 bg-[#0d1b2a]/20 mx-auto mb-12 rounded-full"></div>

                  <p className="text-xl md:text-2xl text-[#0d1b2a]/90 max-w-4xl leading-relaxed mb-16 font-light px-4">
                    Dive deep into the world of sports with expert analysis, game breakdowns, and insights that go
                    beyond the scoreboard. From tactical masterclasses to player spotlights, discover the stories that
                    make sports truly captivating.
                  </p>
              ...
              <div id="posts-section" className="flex justify-center items-center py-32">
                <div className="text-center bg-white/15 backdrop-blur-md rounded-3xl p-16 shadow-2xl border border-white/30 max-w-lg mx-auto">
                  <div className="relative mb-8">
                    <div className="animate-spin rounded-full h-20 w-20 border-4 border-[#0d1b2a]/20 border-t-[#0d1b2a] mx-auto"></div>
                  </div>

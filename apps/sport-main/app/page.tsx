        ...
        <div className="relative z-20 h-full flex items-center justify-end pr-16">
          <div className="font-main text-right text-white max-w-6xl">
            <motion.div initial="hidden" animate="visible" variants={titleVariants} className="p-8">
              ...
              >
                Scroll to explore the beautiful game.
              </motion.p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="relative z-20 h-full w-full flex items-center">
          <div className="container mx-auto px-12">
            ...
            >
              ...
              >
                Dive into the tactical world where strategy meets athleticism. Every play tells a story; every match
                evokes pure emotion.
              </motion.p>
              <motion.a
                href="/blog"
          ...
          <div className="container mx-auto px-12">
            ...
            >
              ...
              <motion.p
                ...
                className="text-2xl text-gray-200 mb-16 leading-relaxed font-light"
              >
                Expressing my honest views on the latest matches and tournaments. Raw thoughts and unfiltered opinions
      ...
      <section className="h-screen w-full relative overflow-hidden">
        <div className="absolute inset-0 flex">
          ...
          <div className="flex-1">
            <StaticImage src={images[0]!} alt="Football stadium atmosphere" />
          </div>
          <div className="flex-1">
            <StaticImage src={images[1]!} alt="Players in action" />
          </div>
          <div className="flex-1">
            <StaticImage src={images[2]!} alt="Championship moments" />
          </div>
        </div>

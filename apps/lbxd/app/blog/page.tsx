      ...
      <main className="w-full flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl mx-auto px-6">
          ...
          <header className="pt-20 pb-14 w-full flex flex-col items-center text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-2xl leading-relaxed font-light text-center">
          ...
          {loading ? (
            ...
            <div id="posts-section"className="w-full flex justify-center items-center py-32">
              <div className="bg-[#183446] rounded-2xl p-16 w-full max-w-xl text-center shadow-md border border-[#046e8f]/40">
                ...
                <p className="text-gray-400 text-lg mb-6 font-light text-center">
            ...
            {/* Posts Section - All Centered */}
            <div id="posts-section" className="py-12 w-full">
              <div className="w-full flex flex-col items-center gap-12">
                {currentPosts.map((post, index) => (
                  <article
                    key={post.id}
                    className="group w-full max-w-3xl bg-[#183446] rounded-2xl p-10 shadow-md border border-[#046e8f]/40 hover:border-[#38aecc] transition-all duration-300"
                  >
                    {/* Meta Information - Centered with Creative Layout */}
                    ...
                    <div className="text-center mb-6">
                      <h2 className="text-3xl md:text-4xl font-bold text-[#38aecc] group-hover:text-[#0090c1] transition-colors">
                        {post.title}
                      </h2>
                    </div>

                    {/* Excerpt - Centered with Max Width */}
                    ...
                    {/* Creative alternating alignment for visual interest */}
                    {index % 3 === 1 && (
